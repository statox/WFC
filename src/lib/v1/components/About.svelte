...
<p>
    "Tiles" allows to create new tiles and save them to the local storage. For now the sprites are
...
<p>
    "Connections" display the hard coded connections. For now there is now way to edit them but they
